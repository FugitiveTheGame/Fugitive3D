...
echo --=== Flat clients ===--
butler push releases/Fugitive3D_Client_Flat_Windows.zip stumpy-dog-studios/fugitive-3d:windows-flat-beta --userversion-file vesion.txt
...
echo --=== Servers ===--
butler push releases/Fugitive3D_Server_Windows.zip stumpy-dog-studios/fugitive-3d:windows-server-beta --userversion-file vesion.txt
