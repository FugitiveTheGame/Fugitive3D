...
:CLIENTS_FLAT
echo --=== Flat clients ===--
butler push --ignore .gitkeep --ignore godot_oculus.dll --ignore libgodot_openvr.dll --ignore openvr_api.dll ..\..\export\client\flat\windows stumpy-dog-studios/fugitive-3d:windows-flat --userversion-file vesion.txt
butler push --ignore .gitkeep --ignore libgodot_openvr.so --ignore libopenvr_api.so ..\..\export\client\flat\linux stumpy-dog-studios/fugitive-3d:linux-flat --userversion-file vesion.txt
...
:SERVERS
echo --=== Servers ===--
butler push --ignore .gitkeep --ignore godot_oculus.dll --ignore libgodot_openvr.dll --ignore openvr_api.dll ..\..\export\server\windows stumpy-dog-studios/fugitive-3d:windows-server --userversion-file vesion.txt
butler push --ignore .gitkeep --ignore libgodot_openvr.so --ignore libopenvr_api.so ..\..\export\server\linux stumpy-dog-studios/fugitive-3d:linux-server --userversion-file vesion.txt
